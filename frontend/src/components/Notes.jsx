...
const Notes = () => {
  ...
  const themeStyles = {
    container: theme === 'dark' ? 'text-gray-200' : 'text-gray-800',
    section: theme === 'dark' ? 'bg-gray-700' : 'bg-gray-200',
    title: theme === 'dark' ? 'text-gold' : 'text-gray-800',
    card: theme === 'dark' ? 'bg-gray-800 text-white' : 'bg-gray-300 text-gray-800',
    code: theme === 'dark' ? 'inline-block px-2 py-0.5 rounded-md text-gray-300 bg-gray-800' 
                           : 'inline-block px-2 py-0.5 rounded-md text-gray-600 bg-gray-200',
  };
  ...
  return (
    <div className={`py-8 px-5 bg-inherit ${themeStyles.container}`}>
